        ...
        <div class="catalog-aside__wrap">
            <div class="catalog-aside-block">
                <div class="catalog-aside-block__top">
                    ...
                    <button class="catalog-filter-wrap__remove"onclick="location.href = location.pathname">Очистити все</button>
                </div>
                    ...
                    <form action="<?=$this->alias('catalog' . (!empty($this->parameters['alias']) ? '/' . $this->parameters['alias'] : ''))?>" class="catalog-filter">
                        ...
                        <?php if (!empty($catalogPrices)):?>
                            ...
                            <div class="catalog-filter-item catalog-filter-item_open">
                                <div class="catalog-filter-item__title">Ціна<span class="catalog-filter-item__toggle"></span>
                                </div>
                                    ...
                                    <div class="catalog-range-slider">
                                        <div class="catalog-filter-range__inputs">
                                            <div class="catalog-filter-range__limit">
                                                <div class="catalog-filter-range__text">Від</div>
                        ...
                        <button class="card-item__btn">Вибрати</button>
                          ...
                          <?php if (!empty($order)):?>
                            ...
                            <div class="catalog-section-top-items__title catalog-section-top-items__unit">
                                ...
                                <?php foreach ($order as $name => $item):?>
                                    ...
                                    <a href="<?=$this->alias('catalog/' . ($this->parameters['alias'] ?? ''), array_merge($_GET ?? [], ['order'=>$item]))?>"
                            ...
                            <div class="catalog-section-top-items__unit catalog-section-top-items__toggle" onclick="this.querySelector('.qtyItems').classList.toggle('opened')">
                                ...
                                Показувати по: <span><?=$_SESSION['quantities'] ?? ''?></span>
