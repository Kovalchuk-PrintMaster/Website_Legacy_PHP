...
//        $httpReferer = str_replace('/', '\/', $_SERVER['HTTP_X_FORWARDED_PROTO'] . '://' . $_SERVER['SERVER_NAME'] . PATH . $route['admin']['alias']);
        $httpReferer = str_replace('/', '\/', $_SERVER['HTTP_ORIGIN'] . PATH . $route['admin']['alias']);
