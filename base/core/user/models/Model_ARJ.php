...
//
//                            'where' => $filtersWhere,
////                        'order'=>$filtersOrder, // from comments under video
//
//                            'join' => [
////                                'filters_categories' => [
//                                'filters f_name' => [
...
//                                    'where' => $filtersWhere,
//                                    'on' => ['parent_id', 'id'] // lesson 125, 44min undefined situation maybe problem with version software ['parent_id', 'id'] not work
//                                ],
//
//                                'goods_filters' => [
//                                    'on' => [
